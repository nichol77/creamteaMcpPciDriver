...
struct mcpPciDriverRead {
  unsigned int barno;
  unsigned int address;
  unsigned int value;
};

#define TEST_IOCREAD _IOWR(TEST_IOC_MAGIC, TEST_IOC_MINNR+0, struct mcpPciDriverRead)
#define TEST_IOCWRITE _IOWR(TEST_IOC_MAGIC, TEST_IOC_MINNR+1, struct mcpPciDriverRead)
